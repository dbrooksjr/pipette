...
public class PBlocks {
    ...
    public static void register() {
        ...
        DESTROYER_ENTITY = Registry.register(Registry.BLOCK_ENTITY_TYPE, Destroyer.ID, BlockEntityType.Builder.create(DestroyerEntity::new, PBlocks.DESTROYER).build(null));
